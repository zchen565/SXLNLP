    ...
    def load(self):
        ...
        with open(self.path, encoding="utf8") as f:
            ...
            for segment in segments:
                ...
                input_ids = self.tokenizer(s, max_length = 102, padding="max_length", truncation=True, return_tensors="pt")
                ...
                '''
                check whether this is the same form as our original model !!!
                '''
        return
